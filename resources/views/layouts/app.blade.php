...
<body>
    <div id="app" >
        ...
        <!-- Navigation Bar-->
        <header id="topnav">
            <div class="topbar-main" style="background-color: #ffda93;">
                <div class="container-fluid">
                    ...
                    <div class="logo">
                        ...
                        <a href="index.html" class="logo">
                            <h4 style="color: black;">Aplikasi Restoran</h4>
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        © 2022 Restoran<span class="d-none d-sm-inline-block"> <i class="mdi mdi-heart text-danger"></i> </span>.
                    </div>
                </div>
            </div>
        </footer>
